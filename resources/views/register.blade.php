            ...
            <div class="col-md-5 col-lg-4">
                ...
                <div class="card login-card bg-white">
                    <div class="card-body p-3">
                        ...
                        <p class="text-secondary small mb-4">Create a new account to get started</p>
                        ...
                        <form>
                            ...
                            <div class="d-grid">
                                <button type="submit" class="btn btn-brand py-2">Register</button>
                            </div>
                        </form>
                    </div>
                </div>
